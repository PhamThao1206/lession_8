...
<div class="container mt-3">
    ...
    <a class="btn btn-success" href="./edit.php"></a>
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td>
                <form id="edit_<?= $product['id'] ?>" action="./edit.php" method="post">
                    <input type="hidden" value="<?= $product['id'] ?>" name="id">
                    <button type="button" class="btn btn-success" onclick="confirmEdit(<?= $product['id'] ?>)">Edit</button>
                </form>
            </td>
        </tr>
        <?php endforeach; ?>
